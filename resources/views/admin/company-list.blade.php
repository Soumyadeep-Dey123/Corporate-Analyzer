                    ...
                    <div class="col-md-12 col-lg-12 shadow">
                        <div class="card">
                            <div class="card-header d-inline-flex">
                                <h3 class="p-x-4">Company List Table</h3>
                                @php
                                ...
                                <i class="fa " aria-hidden="true">
                                    <button type="button" class="fa-plus btn btn-primary"
                                        ...
                                        title="{{ $add_title }}" data-bs-toggle="modal"
                                        ...
                                        @foreach ($companies as $company)
                                            <tr class="{{ $company->status_class }}">
                                                ...
                                                <td align="center">
                                                    ...
                                                    @endphp
                                                    <a href="#" class="confirm-redirect"
                                                        data-url="{{ route('admin.companies.status-update', ['id' => $company->id]) }}">
                                                        <i style="color:{{ $icolor }}"
                                                            class="company-status fa-solid fa-{{ $icon }}"
                                                            title="{{ $title }}"></i>
                                                    </a>
                                                </td>
                                                <td>
                                                    ...
                                                    @endphp
                                                    <i class="fas" title="{{ $edit_title }}"><button type="button"
                                                            class="fas fa-edit btn btn-warning edit-btn"
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            editModal.addEventListener("show.bs.modal", function(event) {
                ...
                document.getElementById("editForm").action = "{{ route('admin.companies.update', '') }}/" +
                    id;
            });
        });
